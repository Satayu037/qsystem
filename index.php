                    ...
                    <tbody>
                        ...
                        foreach ($result as $r) { ?>
                            <tr>
                                ...
                                <td><img src="./Picture/<?= $r['Image'];?>" width="50px" height="50" alt="image" class="box"onclick="enlargeImg()" id="img1"></td>
                                <td>
                                 <?= $r['QStatus'] ?>
                                </td>
                                
                                <td>
                                <a href="UpdateQueueForm.php?QDate=<?= $r['QDate']?>&QNumber=<?= $r['QNumber']?>" class="btn btn-warning btn-sm">แก้ไข</a></td>
                <td><a href="DeleteQueue.php?QDate=<?= $r['QDate'] ?>" class="btn btn-danger btn-sm " data-toggle="modal" data-target="#ModalCenter" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a></td>
